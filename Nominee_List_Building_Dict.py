...
nom_count_dict = {}
# Add your code here
for year, list_nom in nominated.items():
    for nom in list_nom:
        if nom not in nom_count_dict:
            nom_count_dict[nom] = 1 
        else:
            nom_count_dict[nom] += 1
...
win_count_dict = {}
# Add your code here
for year, winning_director in winners.items():
    for winner in winning_director:
...
#ORRRRR WE CAN USE .GET! NOTE: I COPIED UDACITY SOLUTION SO THEY CALL THE KEYS,VALUES SOMETHINGS ELSE FOR WIN_COUNT_DICT*
win_count_dict = {}
